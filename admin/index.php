...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="navbar-collapse collapse justify-content-end" id="navbarSupportedContent">
    <?php $showuser = $_SESSION['user_login']; $haha = mysqli_query($db_con,"SELECT * FROM `usuario` WHERE `nombre_usuario`='$showuser';"); $showrow=mysqli_fetch_array($haha); ?>
    <ul class="nav navbar-nav ">
      <li class="nav-item"><a class="nav-link" href="index.php?page=user-profile"><i class="fa fa-user"></i> Hola, <?php echo $showrow['nombre_usuario']; ?>!</a></li>
...
<br>
          ...
          <div class="col-md-3">
            <div class="list-group">
              <a href="index.php?page=dashboard" class="list-group-item list-group-item-action active">
               <i class="fa fa-edit"></i> Panel de Control
              </a>
    ...
    <div class="clearfix"></div>
      ...
      <br><br><br>
      <center><h2>Especilidad: <a href="#">Analisis de Sistemas</a></h2></center>
